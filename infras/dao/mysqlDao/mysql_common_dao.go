...
*/
func (m *MysqlClient) GetOne(tableName string, where map[string]interface{}, selectField []string, result DaoMysqlSchema) error {
	if nil == m.Db {
...
*/
func (m *MysqlClient) GetMulti(tableName string, where map[string]interface{}, selectField []string, results interface{}) error {
	if nil == m.Db {
		return errors.New("mysql.DB object couldn't be nil")
	}
	condition, values, err := builder.BuildSelect(tableName, where, selectField)
...
*/
func (m *MysqlClient) Insert(tableName string, data []map[string]interface{}) (int64, error) {
	if nil == m.Db {
...
@return LastInsertId int64						返回最新的插入id
*/
func (m *MysqlClient) InsertIgnore(tableName string, data []map[string]interface{}) (int64, error) {
	if nil == m.Db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
...
@return LastInsertId int64						返回最新的插入id
*/
func (m *MysqlClient) InsertReplace(tableName string, data []map[string]interface{}) (int64, error) {
	if nil == m.Db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
...
*/
func (m *MysqlClient) Update(tableName string, where, data map[string]interface{}) (int64, error) {
	if nil == m.Db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
...
*/func (m *MysqlClient) Delete(tableName string, where map[string]interface{}) (int64, error) {
	if nil == m.Db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
...
*/func (m *MysqlClient) GetCount(tableName string, where map[string]interface{}) (int64, error) {
	if nil == m.Db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
